...
make -j$(nproc) CXXFLAGS="-O3 -flto -Werror=odr -Werror=lto-type-mismatch -Werror=strict-aliasing"
...
make -j$(nproc) CXXFLAGS="-O3 -flto -Werror=odr -Werror=lto-type-mismatch -Werror=strict-aliasing -I$ROOTDIR/include" LDFLAGS="-L$ROOTDIR/lib -ltorrent"
make -j$(nproc) install
